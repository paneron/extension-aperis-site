...
export const DEFAULT_FOOTER_BANNER_SVG = `<?xml version="1.0" encoding="utf-8"?>
...
export const DEFAULT_HEADER_BANNER_SVG = `<svg width="30" height="29" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const SETTINGS_STUB: SiteSettings = {
  title: "My Open Project Site",
